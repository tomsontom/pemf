 ...
 * @generated
 */
public class SampleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SamplePackage.REGION: {
				...
				if (result == null) result = caseBaseObject(region);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
